        ...
        <form action="mypage.php" method="post">
            <div class="form_contents">
                <div class="mail">
                    ...
                    <input type="text" class="formbox" size="40" name="mail" value="<?php if(isset($_COOKIE['login_keep'])){echo $_COOKIE['mail'];}?>" name="mail">
                </div>
                <div class="password">
                ...
                <div class="login_issue">
                    <!-- <a href="reset_password">パスワードをお忘れの方<br></a> -->
                    <!--リセット処理(本人確認のいい方法が思いつかなかったため、とりあえずスキップ)-->
                    <a href="register.php">アカウントをお持ちでないですか？アカウント作成</a>
                </div>
            </div>
        </form>
    </main>
